...
<head>
	...
	<!-- Le styles -->
	<link href="/dbyll/assets/resources/bootstrap/css/bootstrap.min.css" rel="stylesheet">
	<link href="/dbyll/assets/resources/font-awesome/css/font-awesome.min.css" rel="stylesheet">
	<link href="/dbyll/assets/resources/syntax/syntax.css" rel="stylesheet">
	<link href="/dbyll/assets/css/style.css" rel="stylesheet">
	...
	<link rel="alternate" type="application/rss+xml" title="" href="/dbyll/feed.xml">
</head>
...
<body>
	<nav class="navbar navbar-default visible-xs" role="navigation">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="/dbyll/">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li class="active"><a href="/dbyll/">Home</a></li>
				<li><a href="/dbyll/categories.html">Categories</a></li>
				<li><a href="/dbyll/tags.html">Tags</a></li>
			</ul>
		</div><!-- /.navbar-collapse -->
	</nav>
	...
	<div class="btn-group hidden-xs" id="nav-menu">
		...
		<ul class="dropdown-menu" role="menu">
			<li><a href="/dbyll/"><i class="fa fa-home"></i>Home</a></li>
			<li><a href="/dbyll/categories.html"><i class="fa fa-folder"></i>Categories</a></li>
			<li><a href="/dbyll/tags.html"><i class="fa fa-tags"></i>Tags</a></li>
			<li class="divider"></li>
...
<div id="contact-list" class="text-center">
	...
	<ul id="contact-list-secondary" class="list-unstyled list-inline">
		...
		<li>
			<a class="btn btn-default btn-sm" href="/dbyll/feed.xml">
...
<!-- project-block -->
<ins class="adsbygoogle pull-right"
     style="display:inline-block;width:300px;height:250px"
     data-ad-client="ca-pub-7616772085785107"
     data-ad-slot="7971084020"></ins>
...
<article class="home">
  ...
  <h2>
    <a href="/dbyll/general/setup/demo/2013/11/15/hello-world.html">Hello World!</a>
  </h2>

  <div>
    
    <p><strong>dbyll</strong> is minimalist, stylish theme for jekyll. Supports gravatar, account links (github, twitter, e-mail, pinterest, résume file) and a bio.</p>
...
<article class="home">
  ...
  <h2>
    <a href="/dbyll/general/setup/demo/2013/11/15/configuration.html">Configuration</a>
  </h2>
...
<span class="s">disqus</span><span class="pi">:</span> <span class="s">dbyll-ghost</span> <span class="c1"># disqus short name</span>
...
<article class="home">
  ...
  <h2>
    <a href="/dbyll/general/demo/2013/11/14/sample.html">Sample</a>
  </h2>
...
<article class="home">
  ...
  <h2>
    <a href="/dbyll/general/demo/sample/2013/11/14/sample-2.html">Sample 2</a>
  </h2>
...
<div class="clearfix"></div>
		...
		<footer>
			<hr/>
			<p>
				&copy; 2017 dbyll with <a href="http://jekyllrb.com/">Jekyll</a>. Theme: <a href="https://github.com/dbtek/dbyll">dbyll</a> by dbtek.
			</p>
		</footer>
	</div>
	<script>
	...
	<script type="text/javascript" src="/dbyll/assets/resources/jquery/jquery.min.js"></script>
	<script type="text/javascript" src="/dbyll/assets/resources/bootstrap/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="/dbyll/assets/js/app.js"></script>
</body>
</html>
